...
def printPlotRandom_masked(ArrResilD, ArrResilER, ArrResilUPA, numNodes, fileName):
    ...
    ax.axhline(y=y_threshold, linewidth=0.5, color="#433C3C", label="75% dei nodi attivi")
    ax.axvline(x=x_threshold, linewidth=0.5, color="#797676", label="20% dei nodi disattivati")
